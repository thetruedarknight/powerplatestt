...
export default function LandingPage({ onStart, nextDelivery, cutoffDate }) {
  return (
    <div className="min-h-screen flex flex-col items-center justify-start bg-gradient-to-br from-green-100 via-green-200 to-green-300 p-6 text-gray-800">
      ...
      <section className="max-w-2xl text-left mb-8">
        ...
        <p className="mb-4">
          Choose from our rotating weekly menu. We deliver chilled, ready-to-eat meals weekly to most locations within Trinidad. Once you've placed your order, one of our friendly team members will get in touch with you to confirm delivery details.
        </p>
        <p className="mb-4">
  ...
  Orders placed <span className="font-semibold text-red-600 animate-pulse"> by 6 a.m. on{" "} {cutoffDate}</span> will get delivered on{" "}
