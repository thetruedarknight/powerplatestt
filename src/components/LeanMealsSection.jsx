export default function LeanMealsSection({ items, quantities, setQuantities, doubleMeatPrice }) {
    ...
    return (
      <section className="py-10 px-4 sm:px-6 bg-white text-gray-800">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-8">🥗 Lean Meals - Less Than 450 Calories</h2>
